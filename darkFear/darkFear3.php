...
<div id="challenge" class="form" style="padding-top:40px">
    <div class="form-content" style="max-width:600px">
      ...
      <div style="text-align:center!important"><br>
        ...
        <img src="../photos/checkMonsters.png" style="width:70%;">
      </div>
      ...
      <form style="padding:0.01em 16px" action='unsetvar.php' method='post'>
        <div style="margin-top:16px!important;margin-bottom:16px!important">
         <p>  3)Challenge your fears<br/>
			<fieldset class="group1"style="border-radius: 5px; background-color: #b3ff66; padding-bottom:4px;  ">
				<input type="checkbox" onclick="crossElem()" name="group1" value="step1" id="step1" /><label id="1" >When you get into bed at night, ask yourself what you’re really afraid of</label></input></br>
				<input type="checkbox" onclick="crossElem()" name="group1" value="step2" id="step2" /> <label id="2" >If you think there’s someone in your closet, under your bed, check that place. </label></input></br>
				<input type="checkbox" onclick="crossElem()" name="group1" value="step3" id="step3" /> <label id="3" >Show yourself that there’s nothing to see and nothing to be worried about.</label></input></br>
				<input type="checkbox" onclick="crossElem()" name="group1" value="step4" id="step4" /> <label id="4" >Try sleeping with somenone in order to sleep more at ease.</label></input></br>
			</fieldset >
		</p>
