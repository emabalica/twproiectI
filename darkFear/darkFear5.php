...
<div id="challenge" class="form" style="padding-top:40px">
    <div class="form-content" style="max-width:600px">
      <div style="text-align:center!important"><br>
        ...
        <img src="../photos/perspective.png" style="width:70%;">
      </div>
      ...
      <form style="padding:0.01em 16px" action='unsetvar.php' method='post'>
        <div style="margin-top:16px!important;margin-bottom:16px!important">
         <p>5)Change your ideas of darkness<br/>
			<fieldset class="group1"style="border-radius: 5px; background-color: #b3ff66; padding-bottom:4px;  ">
				<input type="checkbox" onclick="crossElem()" name="group1" value="step1" id="step1" /><label id="1" >To start embracing the darkness,think of it as calming or even comforting like a thick blanket.</label></input></br>
				<input type="checkbox" onclick="crossElem()" name="group1" value="step2" id="step2" /> <label id="2" >Write down all of the things you associate with darkness</label></input></br>
				<input type="checkbox" onclick="crossElem()" name="group1" value="step3" id="step3" /> <label id="3" >As silly as it may sound,cross them out or tear up this piece of paper</label></input></br>
				<input type="checkbox" onclick="crossElem()" name="group1" value="step4" id="step4" /> <label id="4" >Then, you should write down new, more positive associations.</label></input></br>
			</fieldset >
		</p>
