...
<div id="challenge" class="form" style="padding-top:40px">
    <div class="form-content" style="max-width:600px">
      <div style="text-align:center!important"><br>
        <span onclick="location.href = 'http://localhost/siteFinal/darkFear/FearDarkStart.php'" class="button" style="position:absolute;right:0;top:0;color:red!important;background-color:white!important;font-size:24px!important;">&times;</span>
        <img src="../photos/warmRoom.png" style="width:70%;">
      </div>
      ...
      <form style="padding:0.01em 16px" action='unsetvar.php' method='post'>
        <div style="margin-top:16px!important;margin-bottom:16px!important">
         <p>4)Make your room more inviting<br/>
			<fieldset class="group1"style="border-radius: 5px; background-color: #b3ff66; padding-bottom:4px;  ">
				<input type="checkbox" onclick="crossElem()" name="group1" value="step1" id="step1" /><label id="1" >Keep it nice and neat so there is less fear that there’s something hiding in a messy closet</label></input></br>
				<input type="checkbox" onclick="crossElem()" name="group1" value="step2" id="step2" /> <label id="2" >Aim to have warm, bright colors in your room so it has a more peaceful and positive energy </label></input></br>
				<input type="checkbox" onclick="crossElem()" name="group1" value="step3" id="step3" /> <label id="3" >Don’t overcrowd your room with furniture or you’ll feel suffocated</label></input></br>
				<input type="checkbox" onclick="crossElem()" name="group1" value="step4" id="step4" /> <label id="4" >Hang up pictures that make you feel safe and comforted</label></input></br>
			</fieldset >
		</p>
