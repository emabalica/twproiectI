...
<div id="challenge" class="form" style="padding-top:5px">
    <div class="form-content" style="max-width:600px">
      <div style="text-align:center!important"><br>
			...
			<img src="../photos/beatHeights.png" style="width:70%;">
      </div>
		...
		<form style="padding:0.01em 16px" action="unsetvar.php" method='post'>
			<div style="margin-top:16px!important;margin-bottom:16px!important">
				<p> 3)Gradually expose yourself to your fear<br/>
				<fieldset class="group1"style="border-radius: 5px; background-color: #b3ff66; padding-bottom:4px;  ">
					<input type="checkbox" onclick="crossElem()" name="group1" value="step1" id="step1"/>  <label id="1" >Start by simply studying on a 2nd-story balcony </label></input></br>
					<input type="checkbox" onclick="crossElem()" name="group1" value="step2" id="step2" /> <label id="2" >Next, you could try to hike a large hill and look down over the distance you covered</label></input></br>
					<input type="checkbox" onclick="crossElem()" name="group1" value="step3" id="step3" /> <label id="3" >When you're comfortable, continue exposing yourself to greater heights</label></input></br>
					<input type="checkbox" onclick="crossElem()" name="group1" value="step4" id="step4" /> <label id="4" >Take pride in each accomplishment and don't lose momentum.</label></input></br>
				</fieldset >
				</p>
