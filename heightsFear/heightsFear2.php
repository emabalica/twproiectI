...
<div id="challenge" class="form" style="padding-top:5px">
    <div class="form-content" style="max-width:600px">
      <div style="text-align:center!important"><br>
			...
			<img src="../photos/relaxHeights.png" style="width:70%;">
      </div>
		...
		<form style="padding:0.01em 16px" action="unsetvar.php" method='post'>
			<div style="margin-top:16px!important;margin-bottom:16px!important">
				...
				<fieldset class="group1"style="border-radius: 5px; background-color: #b3ff66; padding-bottom:4px;  ">
					<input type="checkbox" onclick="crossElem()" name="group1" value="step1" id="step1"/>  <label id="1" >Relaxation activities that focus on embodiment can influence how your fear affects your life </label></input></br>
					<input type="checkbox" onclick="crossElem()" name="group1" value="step2" id="step2" /> <label id="2" >Starting small, like going on walks regularly or drinking more homemade fruit smoothies  </label></input></br>
					<input type="checkbox" onclick="crossElem()" name="group1" value="step3" id="step3" /> <label id="3" >Remove caffeine from your diet to make you more relaxed(which can make it easier to confront your fear)</label></input></br>
					<input type="checkbox" onclick="crossElem()" name="group1" value="step4" id="step4" /> <label id="4" >Getting regular exercise, plenty of sleep, and maintaining a healthy diet </label></input></br>
				</fieldset >
				</p>
