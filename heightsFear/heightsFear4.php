...
?>
 ...
 <!--QUIZ PART 1-->
<div id="challenge" class="form" style="padding-top:5px">
    <div class="form-content" style="max-width:600px">
      <div style="text-align:center!important"><br>
			<span onclick="location.href = 'http://localhost/siteFinal/heightsFear/heightsFearStart.php';" class="button" style="position:absolute;right:0;top:0;color:red!important;background-color:white!important;font-size:24px!important;">&times;</span>
			<img src="../photos/helpHeights.png" style="width:70%;">
      </div>
		...
		<form style="padding:0.01em 16px" action="unsetvar.php" method='post'>
			<div style="margin-top:16px!important;margin-bottom:16px!important">
				<p> 4)Find a therapist that suits your needs.<br/>
				<fieldset class="group1"style="border-radius: 5px; background-color: #b3ff66; padding-bottom:4px;  ">
					<input type="checkbox" onclick="crossElem()" name="group1" value="step1" id="step1"/>  <label id="1" >Before beginning a therapy program, look into the education and certification of those therapists</label></input></br>
					<input type="checkbox" onclick="crossElem()" name="group1" value="step2" id="step2" /> <label id="2" >Try to find a therapist who has been in practice long enough to generate a number of happy former patients</label></input></br>
					<input type="checkbox" onclick="crossElem()" name="group1" value="step3" id="step3" /> <label id="3" >Think twice about therapists who seem inexperienced or are unable to back up claims of success</label></input></br>
					<input type="checkbox" onclick="crossElem()" name="group1" value="step4" id="step4" /> <label id="4" >Think about trying holistic and alternative methods</label></input></br>
				</fieldset >
				</p>
 ...
 function updateItem()
  {
	...
	if (document.getElementById("step4").checked)
    {
	  ...
	  createCookie('patruHeights','2',10);
    }
