...
<div id="challenge" class="form" style="padding-top:40px">
    <div class="form-content" style="max-width:600px">
      <div style="text-align:center!important"><br>
			...
			<img src="../photos/exposureHeights.png" style="width:70%;">
      </div>
		...
		<form style="padding:0.01em 16px" action="unsetvar.php" method='post'>
			<div style="margin-top:16px!important;margin-bottom:16px!important">
				<p> 1)Determine the exact triggers for and intensity of your fear.<br/>
				<fieldset class="group1"style="border-radius: 5px; background-color: #b3ff66; padding-bottom:4px;  ">
					<input type="checkbox" onclick="crossElem()" name="group1" value="step1" id="step1"/>  <label id="1" >Go back in time to the point when your phobia started </label></input></br>
					<input type="checkbox" onclick="crossElem()" name="group1" value="step2" id="step2" /> <label id="2" >Sit down and make a list with all the things that your fear stopped you from doing </label></input></br>
					<input type="checkbox" onclick="crossElem()" name="group1" value="step3" id="step3" /> <label id="3" >If you are terrified by heights show strength by seeking real treatment</label></input></br>
					<input type="checkbox" onclick="crossElem()" name="group1" value="step4" id="step4" /> <label id="4" >Remember that you are not alone and there are many others out there struggling </label></input></br>
				</fieldset >
				</p>
