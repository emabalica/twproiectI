...
<nav class="small_menu bar-block black box animation hide-menu" style="display:none" id="menu">
  ...
  print" <a onclick=\"document.getElementById('quizpart1').style.display='block';close_menu()\" onclick=\"close_menu()\" class=' item button'>PHOBIA QUIZ</a>
		<a href='http://localhost/siteFinal/friends/seeFriends.php' class=' item button '><i class='icon user_icon' ></i>FRIENDS</a>
		<a href='http://localhost/siteFinal/phpDocs/logout.php' onclick=\"close_menu()\" class='item button'>LOGOUT</a>";
  }
...
print "<div class=' containerPhobiGroups' >
						...
						<a href='http://localhost/siteFinal/heightsFear/heightsDarkStart.php'><img src='../photos/fearHeights.png' style='width:40%;padding-left:30%;'></a>
...
<div class="bestart" style="padding:40px 16px" >
  <img src="../photos/heightsStart.png" style="width:30%;padding-left:35%;">
...
if(strcmp($stagiu_provocare,'1')==0){
 print "<a href='http://localhost/siteFinal/heightsFear/heightsFear1.php'><button  class=' item button decorate ' style='width:40%;margin-left:30%' type='submit'>START</button></a>";}

if(strcmp($stagiu_provocare,'2')==0){
 print "<a href='http://localhost/siteFinal/heightsFear/heightsFear2.php'><button  class=' item button decorate '  style='width:40%;margin-left:30%' type='submit'>START</button></a>";}

 if(strcmp($stagiu_provocare,'3')==0){
 print "<a href='http://localhost/siteFinal/heightsFear/heightsFear3.php'><button  class=' item button decorate '  style='width:40%;margin-left:30%' type='submit'>START</button></a>";}

 if(strcmp($stagiu_provocare,'4')==0){
 print "<a href='http://localhost/siteFinal/heightsFear/heightsFear4.php'><button  class=' item button decorate '  style='width:40%;margin-left:30%' type='submit'>START</button></a>";}

 if(strcmp($stagiu_provocare,'5')==0){
 print "<a href='http://localhost/siteFinal/heightsFear/heightsFear5.php'><button  class=' item button decorate '  style='width:40%;margin-left:30%' type='submit'>START</button></a>";}
