...
<head>
	...
	<link rel="stylesheet" href="../css/chartPoints.css">
...
//dark
$id=1;
$stmt=oci_parse($conn,'BEGIN count_phobi(:id,:dark);END;');
		oci_bind_by_name($stmt,':id',$id);
		oci_bind_by_name($stmt,':dark',$dark);
		oci_execute($stmt);

//spiders
$id=2;
$stmt=oci_parse($conn,'BEGIN count_phobi(:id,:spiders);END;');
		oci_bind_by_name($stmt,':id',$id);
		oci_bind_by_name($stmt,':spiders',$spiders);
		oci_execute($stmt);
		
//heights
$id=3;
$stmt=oci_parse($conn,'BEGIN count_phobi(:id,:heights);END;');
		oci_bind_by_name($stmt,':id',$id);
		oci_bind_by_name($stmt,':heights',$heights);
		oci_execute($stmt);
...
<div class="bestart" style="padding:40px 16px" >
	<img src="../photos/commonPhobias.png" style="width:30%;padding-left:35%;">
</div>
...
<div class="_articol color" style="padding:20px 16px;margin-top:10px;">
	<div class="row_padding borduraPhobiGroups" style="border-top:1px solid #ccc" >
		...
		<svg version="1.2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="graph" aria-labelledby="title" role="img">
				<title id="title">Most common phobias</title>
					<g class="grid x-grid" id="xGrid">
					  <line x1="190" x2="190" y1="5" y2="371"></line>
					</g>
					<g class="grid y-grid" id="yGrid">
					  <line x1="190" x2="900" y1="370" y2="370"></line>
					</g>
					  <g class="labels x-labels">
					  <text x="240" y="400"> Dark </text>
					  <text x="360" y="400"> Spiders</text>
					  <text x="460" y="400"> Heights </text>
					  <text x="560" y="400"> Social Phobia </text>
					  <text x="660" y="400"> Deth</text>
					  <text x="760" y="400"> Claustrophobia </text>
					  <text x="550" y="440" class="label-title" style='font-size:15px'> Phobias </text>
					</g>
					<g class="labels y-labels">
					  <text x="180" y="10" > 200 </text>
					  <text x="180" y="100"> 150 </text>
					  <text x="180" y="200"> 100 </text>
					  <text x="180" y="300"> 50 </text>
					  <text x="80" y="200" class="label-title" style='font-size:15px'> Figures </text>
					</g>
					<g  >
					  <circle style='fill:#339900' cx="240"  cy=<?php echo $dark; ?>  r="6"></circle>
					  <circle style='fill:#44cc00' cx="360" cy=<?php echo $spiders; ?>  r="6"></circle>
					  <circle style='fill:#4ce600' cx="460" cy=<?php echo $heights; ?> r="6"></circle>
					  <circle style='fill:#77ff33' cx="560"  cy=<?php echo $dark; ?>  r="6"></circle>
					  <circle style='fill:#aaff80' cx="660" cy=<?php echo $spiders; ?>  r="6"></circle>
					  <circle style='fill:#1aff1a' cx="760" cy=<?php echo $heights; ?>  r="6"></circle>
