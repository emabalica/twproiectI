<?php include '../phpDocs/dbcon.php'?> <!--Coping with Panic Attacks-->
...
<div class="_articol color" style="padding:20px 16px;margin-top:10px;">
	<div class="row_padding borduraPhobiGroups" style="border-top:1px solid #ccc" >
		<div class="continut_articol " >  
				<h2>Coping with Panic Attacks</h2>
				<p>	A panic attack is a sudden surge of mounting physiological arousal that can occur "out of
					the blue" or in response to encountering (or merely thinking about) a phobic situation. Bodily
					symptoms that occur with the onset of panic can include heart palpitations, tightening in the
					chest or shortness of breath, choking sensations, dizziness, faintness, sweating, trembling,
					shaking, and/or tingling in the hands and feet. Psychological reactions that often accompany
					these bodily changes include feelings of unreality, an intense desire to run away, and fears of
					going crazy, dying, or doing something uncontrollable.Anyone who has had a full-fledged panic attack knows that it is one of the most intensely
					uncomfortable states human beings are capable of experiencing.	
				</p>
		</div>
    <div class="continut_articol" style="margin-top:80px;">
		<img class="image " src="../photos/articol4.png" style="width:450px;margin-left:90px;" >
    </div>
	
	<div style="float:left ;padding-right:25px;">	
			<p> Your very first panic attack
				can have a traumatic impact, leaving you feeling terrified and helpless, with strong anticipatory
				anxiety about the possible recurrence of your panic symptoms. Unfortunately, in some
				cases, panic does come back and occurs repeatedly. Why some people have a panic attack
				only once-or perhaps once every few years—while others develop a chronic condition with
				several attacks a week is still not understood by researchers in the field.
			</p>
