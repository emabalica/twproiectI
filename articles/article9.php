<?php include '../phpDocs/dbcon.php'?> <!--Medication for Anxiety-->
...
<div class="_articol color" style="padding:20px 16px;margin-top:10px;">
	<div class="row_padding borduraPhobiGroups" style="border-top:1px solid #ccc" >
		<div class="continut_articol " >  
				<h2>Medication for Anxiety</h2>
				<p>	The use of medication is a critical issue among those who struggle with anxiety on a daily
					basis, as well as for professionals treating anxiety disorders. For many people, medication
					is a positive turning point along the path to recovery. For others, medication can confuse
					and complicate the recovery process, when freedom from anxiety is purchased at the cost of
					long-term addiction to tranquilizers. For still other people-those who are either phobic of
					or philosophically opposed to all types of drugs—medication may seem not to be an option,
					even when it’s needed. One thing is clear: the pros and cons of relying on medication
					are unique and variable in each individual case.
				</p>
		</div>
    <div class="continut_articol" style="margin-top:80px;">
		<img class="image " src="../photos/articol10.png" style="width:400px;margin-left:90px;" >
    </div>
