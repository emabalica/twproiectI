...
<div id="challenge" class="form" style="padding-top:40px">
    <div class="form-content" style="max-width:600px">
      <div style="text-align:center!important"><br>
			...
			<img src="../photos/spiderClose.png" style="width:70%;">
      </div>
		...
		<form style="padding:0.01em 16px" action="unsetvar.php" method='post'>
			<div style="margin-top:16px!important;margin-bottom:16px!important">
				<p> 3)Tolerate being around a spider.<br/>
				<fieldset class="group1"style="border-radius: 5px; background-color: #b3ff66; padding-bottom:4px;  ">
					<input type="checkbox" onclick="crossElem()" name="group1" value="step1" id="step1"/>  <label id="1" >When there is a spider around, don't automatically run away or scream to someone else to kill it. </label></input></br>
					<input type="checkbox" onclick="crossElem()" name="group1" value="step2" id="step2" /> <label id="2" >Stand far away from it and keep looking at it until you feel less scared.</label></input></br>
					<input type="checkbox" onclick="crossElem()" name="group1" value="step3" id="step3" /> <label id="3" >Keep in mind that you need to make sure and identify it as a non-deadly spider </label></input></br>
					<input type="checkbox" onclick="crossElem()" name="group1" value="step4" id="step4" /> <label id="4" >Slowly move a little closer and stand for some time;do this until you are close to the spider.</label></input></br>
				</fieldset >
				</p>
