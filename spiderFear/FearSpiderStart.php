...
<div class="bestart" style="padding:40px 16px" >
  <img src="../photos/spiderStart.png" style="width:30%;padding-left:35%;">
...
if(strcmp($stagiu_provocare,'1')==0){
 print "<a href='http://localhost/siteFinal/spiderFear/spiderFear1.php'><button  class=' item button decorate ' style='width:40%;margin-left:30%' type='submit'>START</button></a>";}

if(strcmp($stagiu_provocare,'2')==0){
 print "<a href='http://localhost/siteFinal/spiderFear/spiderFear2.php'><button  class=' item button decorate '  style='width:40%;margin-left:30%' type='submit'>START</button></a>";}

 if(strcmp($stagiu_provocare,'3')==0){
 print "<a href='http://localhost/siteFinal/spiderFear/spiderFear3.php'><button  class=' item button decorate '  style='width:40%;margin-left:30%' type='submit'>START</button></a>";}

 if(strcmp($stagiu_provocare,'4')==0){
 print "<a href='http://localhost/siteFinal/spiderFear/spiderFear4.php'><button  class=' item button decorate '  style='width:40%;margin-left:30%' type='submit'>START</button></a>";}

 if(strcmp($stagiu_provocare,'5')==0){
 print "<a href='http://localhost/siteFinal/spiderFear/spiderFear5.php'><button  class=' item button decorate '  style='width:40%;margin-left:30%' type='submit'>START</button></a>";}

 if(strcmp($stagiu_provocare,'6')==0){
 print "<a href='http://localhost/siteFinal/spiderFear/spiderFear6.php'><button  class=' item button decorate '  style='width:40%;margin-left:30%' type='submit'>START</button></a>";}
