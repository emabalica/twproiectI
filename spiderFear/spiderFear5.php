      ...
      <div style="text-align:center!important"><br>
		...
		<form style="padding:0.01em 16px" action="unsetvar.php" method='post'>
			<div style="margin-top:16px!important;margin-bottom:16px!important">
				<p> 5)Consider treatment<br/>
				<fieldset class="group1"style="border-radius: 5px; background-color: #b3ff66; padding-bottom:4px;  ">
					<input type="checkbox" onclick="crossElem()" name="group1" value="step1" id="step1"/>  <label id="1" >If your fear of spiders interferes with your daily life you may need professional help</label></input></br>
					<input type="checkbox" onclick="crossElem()" name="group1" value="step2" id="step2" /> <label id="2" >If your spider phobia is severe, pharmacological treatment is also an option:anti-anxiety medication(Xanax)</label></input></br>
					<input type="checkbox" onclick="crossElem()" name="group1" value="step3" id="step3" /> <label id="3" >Contact your insurance provider directly for a list of approved clinicians.</label></input></br>
					<input type="checkbox" onclick="crossElem()" name="group1" value="step4" id="step4" /> <label id="4" >Download an application developed by a doctor called Phobia Free to help overcome your fear</label></input></br>
				</fieldset >
				</p>
