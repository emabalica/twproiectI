    ...
    <div class="form-content" style="max-width:600px">
      ...
      <form style="padding:0.01em 16px"  method='post'>
        <div style="margin-top:16px!important;margin-bottom:16px!important">
		  ...
		  <button formaction="../phpDocs/registerezultat.php" type="submit" class="button decorate ">Register</button>
...
<form action='rezultat.php?id=2' method='post' id='quizForm' id='2'>
...
";
	...
	if($rid==1)
		{
		echo "
<form action='rezultat.php?id=1' method='post' id='quizForm' id='1'>
	...
	<ul>
     ...
     <input type='submit' value='Continue' />
		...
		{echo "<form action='rezultat.php?id=3' method='post' id='quizForm' id='3'>
