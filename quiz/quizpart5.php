<?php include '../phpDocs/dbcon.php';  $_SESSION['alegere4']=$_POST['group4'];?>
  ...
  <div id="quizpart1" class="form" >
    <div class="form-content" style="max-width:600px">
      ...
      <div style="text-align:center!important"><br>
        ...
        <img src="../photos/dark.png" style="width:40%;">
      </div>

    <form style="padding:0.01em 16px" action="quizpart6.php" method='post'>
        <div style="margin-top:16px!important;margin-bottom:16px!important">
			<p>5.You are in your room and your night light is broken. You...<br/>
				<fieldset id="group1"style="border-radius: 5px; background-color: #bbff99;  ">
					<input type="radio" name="group5" value="snuggle" /> <label>Snuggle up tight and try to sleep </label> </input></br>
					<input type="radio" name="group5" value="noLight" /> <label>I don't have a night light</label> </input></br>
					<input type="radio" name="group5" value="scream" /> <label>Scream</label> </input></br>
					<input type="radio" name="group5" value="indif" /> <label>You couldn't care less</label> </input>
				</fieldset >
			</p>
