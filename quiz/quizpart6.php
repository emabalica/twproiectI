<?php include '../phpDocs/dbcon.php';  $_SESSION['alegere5']=$_POST['group5'];?>
  ...
  <div id="quizpart1" class="form" >
    <div class="form-content" style="max-width:600px">
      ...
      <div style="text-align:center!important"><br>
        ...
        <img src="../photos/camping.png" style="width:40%;">
      </div>

    <form style="padding:0.01em 16px" action="quizpart7.php" method='post'>
        <div style="margin-top:16px!important;margin-bottom:16px!important">
			<p>6.You are on a long vacation in a cabin you...<br/>
					<fieldset id="group1"style="border-radius: 5px; background-color: #bbff99;  ">
						<input type="radio" name="group6" value="lanterns" /> <label>  Pack plenty of lenterns </label> </input></br>
						<input type="radio" name="group6" value="spray" /> <label> Pack plenty of bug spray/spider repellent</label> </input></br>
						<input type="radio" name="group6" value="height" /> <label> Avoid mountains or cliffs at all costs</label> </input></br>
						<input type="radio" name="group6" value="enjoy" /> <label> Just enjoy myself!</label> </input></br>
					</fieldset >
			</p>
