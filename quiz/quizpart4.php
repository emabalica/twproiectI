<?php include '../phpDocs/dbcon.php';  $_SESSION['alegere3']=$_POST['group3'];?>
  ...
  <div id="quizpart1" class="form" >
    <div class="form-content" style="max-width:600px">
      ...
      <div style="text-align:center!important"><br>
        ...
        <img src="../photos/roller.png" style="width:40%;">
      </div>

    <form style="padding:0.01em 16px" action="quizpart5.php" method='post'>
        <div style="margin-top:16px!important;margin-bottom:16px!important">
			 <p>4.You are riding up the funnest, highest, fastest roller coaster. You are just ascending the tallest slope. You...<br/>
				<fieldset id="group4"style="border-radius: 5px; background-color: #bbff99;">
