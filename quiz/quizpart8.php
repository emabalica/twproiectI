<?php include '../phpDocs/dbcon.php';  $_SESSION['alegere7']=$_POST['group7'];?>
  ...
  <div id="quizpart1" class="form" >
    <div class="form-content" style="max-width:600px">
      ...
      <div style="text-align:center!important"><br>
        ...
        <img src="../photos/SNAKE.png" style="width:40%;">
      </div>

    <form style="padding:0.01em 16px" action="result.php" method='post'>
        <div style="margin-top:16px!important;margin-bottom:16px!important">
			<p>9.You spot a water snake in the creek. You..<br />
				<fieldset id="group1"style="border-radius: 5px; background-color: #bbff99;  ">
					<input type="radio" name="group8" value="swim" /> <label> Swim away</label> </input></br>
					<input type="radio" name="group8" value="photo" /> <label> Go and get your camera</label> </input></br>
					<input type="radio" name="group8" value="race" /> <label> Race with it</label> </input></br>
				</fieldset >
			</p>
