  ...
  <div id="quizpart1" class="form" >
    <div class="form-content" style="max-width:600px">
      ...
      <div style="text-align:center!important"><br>
        ...
        <img src="../photos/dog.png" style="width:40%;">
      </div>
    ...
    <form style="padding:0.01em 16px" action="quizpart8.php" method='post'>
        <div style="margin-top:16px!important;margin-bottom:16px!important">
			<p>7.Your friends want to visit a pet store to look at the new dogs. You know very well they have pet spiders there. You....<br/>
				<fieldset id="group1"style="border-radius: 5px; background-color: #bbff99;  ">
					<input type="radio" name="group7" value="leave" /> <label> Leave!! </label> </input></br>
					<input type="radio" name="group7" value="noFear" /> <label> Spiders? Who cares!</label> </input></br>
					<input type="radio" name="group7" value="no" /> <label>  I go and see the doggies of course!</label> </input></br>
				</fieldset >
			</p>
