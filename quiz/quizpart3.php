<?php include '../phpDocs/dbcon.php';  $_SESSION['alegere2']=$_POST['group2'];?>
  ...
  <div id="quizpart1" class="form" >
    <div class="form-content" style="max-width:600px">
      ...
      <div style="text-align:center!important"><br>
        ...
        <img src="../photos/spider.png" style="width:40%;">
      </div>

    <form style="padding:0.01em 16px" action="quizpart4.php" method='post'>
        <div style="margin-top:16px!important;margin-bottom:16px!important">
			<p> 3.You are at summer camp, and spot a daddy long leg. You...<br/>
				<fieldset id="group3" style="border-radius: 5px; background-color: #bbff99;">
