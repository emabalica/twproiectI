<?php include '../phpDocs/dbcon.php'; $_SESSION['alegere1']=$_POST['group1'];?>
  ...
  <div id="quizpart1" class="form" >
    <div class="form-content" style="max-width:600px">
      ...
      <div style="text-align:center!important"><br>
        ...
        <img src="../photos/gender.png" style="width:40%;">
      </div>

    <form style="padding:0.01em 16px" action="quizpart3.php" method='post'>
        <div style="margin-top:16px!important;margin-bottom:16px!important">
        <p> 2.What is your gender?<br/>
		<fieldset id="group2"style="border-radius: 5px; background-color: #bbff99;">
