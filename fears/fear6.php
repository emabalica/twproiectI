...
altogether (Thompson 1999).</p></div>
    <div class="continut_articol" style="margin-top:80px;">
		<img class="image " src="../photos/InjectionPhobia.png" style="width:400px;margin-left:90px;" >
    </div>
...
with blood/injection phobias tend to faint, allowing them to escape from the feared stimulus.</p>
...
<p id="margini">In medical and particularly dental settings, a variety of anesthetics may be used to
