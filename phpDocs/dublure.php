...
<div id="form" class="form">
	...
	<form style="padding:0.01em 16px" >
        <div style="margin-top:16px!important;margin-bottom:16px!important">
			<label><b>You already have an account</b></label>
			<button class="button decorate " formaction="login.php" type="submit">Log in</button>
		</div>
    </form>
...
<div class="recent_art content">
		...
		<?php include"recentArticles.php" ?>
...
<div class="bestart" style="padding:40px 16px" >
	<img src="../photos/bestarticles.png" style="width:30%;padding-left:35%;">
		<div class="container " style="margin-top:64px">  
			<?php include 'mostReadArticles.php' ?>
		</div>
</div>
